...
function GenerateInvoice() {
  html2canvas(document.querySelector("#invoiceCapture")).then((canvas) => {
    ...
    pdf.save('ambuj-enterprises-invoice-001.pdf');
  });
}
        ...
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              <div className="w-100">
                {/* <h4 className="fw-bold my-2">{this.props.info.billFrom||'Ambuj Tripathi'}</h4> */}
                <h4 align="center" className="fw-bold my-2">{'Ambuj Enterprises'}</h4>
                <h6 align="left">
                  Project Guided by : Asst. Prof. Chaya Rawal
                </h6>
