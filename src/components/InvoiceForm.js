...
class InvoiceForm extends React.Component {
  ...
  handleAddEvent(evt) {
    ...
    // Delay the calculation slightly to ensure the state update is complete
    setTimeout(() => {
      this.handleCalculateTotal();
    });
  }
      ...
      <Row>
        <Col md={8} lg={9}>
          ...
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            <div>
              <h3 align="center">Ambuj Enterprises</h3>
              <h6 align="right" style={{ color: 'blue' }}>Project Guided by : Asst. Prof. Chaya Rawal</h6>
            </div>
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            <Button variant="primary" type="submit" className="btn btn-success">Generate Invoice</Button>
